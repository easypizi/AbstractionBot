          ...
          onSetMod: {
            js: {
              inited: function() {
                ...
                this.filePath =
                  this.isValid && this.isValid.mainImg
                    ? this.params.article.mainImg
                    : "";

                this.shareImg =
                  this.isValid && this.isValid.shareImg
                    ? this.params.article.shareImg
                    : "";
                  ...
                  btn._events().on("change", () => {
                    ...
                    if (!isEmpty) {
                      ...
                      if (btn.hasMod("share")) {
                        ...
                        $(".form__share-image-preview").attr(
                          "src",
                          this.shareImg
                        );
                      } else if (btn.hasMod("upload")) {
                        this.uploadPath = "/assets/images/" + file.name;
                        $(".form__upload-image-preview").attr(
                          "src",
                          this.uploadPath
                        );
                        $(".form-field__linkArea").html(
                          "<div>Your link: <p>/assets/images/" +
                            file.name +
                            "</p></div>"
                        );
                      } else {
                        this.filePath = "/assets/images/" + file.name;
                        $(".form__main-image-preview").attr(
                          "src",
                          this.filePath
                        );
                      }
