  ...
  function t() {
    ...
    function p(o, r, i) {
      ...
      o === e.body ? ((s = l), (c = l.scrollX || l.pageXOffset), (n = l.scrollY || l.pageYOffset), (f = u.scroll)) : ((s = o), (c = o.scrollLeft), (n = o.scrollTop), (f = t)),
        a({ scrollable: s, method: f, startTime: p, startX: c, startY: n, x: r, y: i });
    }
    if (!("scrollBehavior" in e.documentElement.style && !0 !== l.__forceSmoothScrollPolyfill__)) {
      var d = l.HTMLElement || l.Element,
        ...
        u = { scroll: l.scroll || l.scrollTo, scrollBy: l.scrollBy, elementScroll: d.prototype.scroll || t, scrollIntoView: d.prototype.scrollIntoView },
      ...
      (l.scroll = l.scrollTo = function() {
        void 0 !== arguments[0] &&
          (!0 !== i(arguments[0])
            ...
            : u.scroll.call(
                l,
                void 0 !== arguments[0].left ? arguments[0].left : "object" != typeof arguments[0] ? arguments[0] : l.scrollX || l.pageXOffset,
                void 0 !== arguments[0].top ? arguments[0].top : void 0 !== arguments[1] ? arguments[1] : l.scrollY || l.pageYOffset
              ));
      }),
        (l.scrollBy = function() {
          void 0 !== arguments[0] &&
            (i(arguments[0])
              ...
              : p.call(l, e.body, ~~arguments[0].left + (l.scrollX || l.pageXOffset), ~~arguments[0].top + (l.scrollY || l.pageYOffset)));
        }),
        ...
        (d.prototype.scrollIntoView = function() {
          if (!0 !== i(arguments[0])) {
            ...
            o !== e.body
              ? (p.call(this, o, o.scrollLeft + r.left - t.left, o.scrollTop + r.top - t.top),
                "fixed" !== l.getComputedStyle(o).position && l.scrollBy({ left: t.left, top: t.top, behavior: "smooth" }))
